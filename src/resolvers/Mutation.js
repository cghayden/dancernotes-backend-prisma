...
const Mutations = {
  ...
  async createStudioEvent(parent, args, ctx, info) {
    ...
    const ageDivision = args.ageDivision;
    delete args.ageDivision;
    const competitiveLevel = args.competitiveLevel;
    delete args.competitiveLevel;
    ...
    return await ctx.db.mutation.createStudioEvent(
      {
        data: {
          ...
          ageDivision: { set: ageDivision },
          competitiveLevel: { set: competitiveLevel },
          style: { set: style },
          ...args,
        },
      },
